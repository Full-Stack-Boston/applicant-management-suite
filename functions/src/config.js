...
const templates = {
		...
		const content = `
            <main style="font-family: Arial, Helvetica, sans-serif; color: #333; padding: 5px; margin: 5px;">
                ...
                <p style="text-align: center; margin: 25px 0;">
                    <a href="${data.waitingRoomURL}" style="background-color: #0288D1; color: white; padding: 12px 20px; text-decoration: none; border-radius: 5px; font-weight: bold;">Join Interview Waiting Room</a>
                </p>
	...
	rsvpConfirmationPage: (brand, response) => `
        <html>
            ...
            <p>Thank you!</p>
            <p><a href="${brand.url}" style="color: #0288D1;">Return to website</a></p>
            </body>
        </html>
    `,
};
